...
from AbhiXMusic.mongo.readable_time import get_readable_time
from AbhiXMusic.mongo.afkdb import add_afk, is_afk, remove_afk


@app.on_message(filters.command(["afk", "brb", "ye"], prefixes=["/", "!", "b", "B"]))
