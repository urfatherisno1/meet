...
async def init():
    ...
    LOGGER("AbhiXMusic.plugins").info("𝐀𝐥𝐥 𝐅𝐞𝐚𝐭𝐮𝐫𝐞𝐬 𝐋𝐨𝐚𝐝𝐞𝐝 𝐁𝐚𝐛𝐲🥳...")
    await userbot.start()
    await Abhi.start()
    try:
        await Abhi.stream_call("https://te.legra.ph/file/29f784eb49d230ab62e9e.mp4")
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("AbhiXMusic").info("𝗦𝗧𝗢𝗣 𝗦𝗧𝗥𝗔𝗡𝗚𝗘𝗥 𝗠𝗨𝗦𝗜𝗖🎻 𝗕𝗢𝗧..")
